...
The [`netcounts`](https://zappem.net/pub/net/netcounts/) package
provides a [Go API](https://pkg.go.dev/zappem.net/pub/net/netcounts)
for monitoring network traffic. It works by parsing the /proc/net
files and also uses the net package to determine the IPv4 and IPv6
addresses of the detected network interfaces.
